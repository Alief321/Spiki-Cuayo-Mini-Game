...
export function Scoreboard({ score, isDarkMode }: ScoreboardProps) {
  return (
    <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="absolute md:top-1/6 top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
      <div
